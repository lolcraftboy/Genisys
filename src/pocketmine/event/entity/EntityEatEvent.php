...
class EntityEatEvent extends EntityEvent implements Cancellable{
	...
	public function getFoodRestore() {
		return (int) $this->foodRestore;
	}

	public function setFoodRestore($foodRestore){
		$this->foodRestore = (int)$foodRestore;
	}

	public function getSaturationRestore() {
		return (float) $this->saturationRestore;
	}

	public function setSaturationRestore($saturationRestore){
		$this->saturationRestore = (float)$saturationRestore;
	}
